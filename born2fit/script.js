// BORN2FIT Cyber Gym - Interactivity Script
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 3. Reviews Carousel logic removed (Section redesigned to a static responsive grid)

    // 4. Custom Gallery Lightbox (Cyber Frame)
    ...
    if (leadForm && formSuccess) {
        leadForm.addEventListener('submit', (e) => {
            ...
            console.log('Lead Captured (BORN2FIT):', { name, phone, goal, timestamp: new Date() });
