// Soul Fitness - Interactivity Script
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 4. Lead Form Submission Handler (Mock)
    ...
    if (leadForm && formSuccess) {
        leadForm.addEventListener('submit', (e) => {
            ...
            console.log('Lead Captured (Soul Fitness):', { name, phone, goal, timestamp: new Date() });
